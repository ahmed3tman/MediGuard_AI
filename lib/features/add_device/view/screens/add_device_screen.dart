...
import '../../../devices/cubit/device_state.dart';
...
class _AddDeviceScreenState extends State<AddDeviceScreen> {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider.value(value: context.read<DeviceCubit>()),
        BlocProvider(create: (_) => PatientInfoCubit()),
      ],
      child: Scaffold(
        appBar: CustomAppBar(
          title: AppLocalizations.of(context).addDeviceScreen,
        ),
            ...
            BlocListener<DeviceCubit, DeviceState>(
              listener: (context, state) {
                if (state is DeviceAdded) {
                  // Save patient info after device is added successfully
                  _savePatientInfo(context);
                        ...
                        return BlocBuilder<PatientInfoCubit, PatientInfoState>(
                          builder: (context, patientState) {
                            ...
                            return CustomButton(
                              ...
                              onPressed: _addDeviceAndPatient,
                              isLoading: isLoading || isPatientLoading,
  ...
  void _addDeviceAndPatient() {
    if (_formKey.currentState!.validate()) {
      final deviceId = _deviceIdController.text.trim();
      final patientName = _patientNameController.text.trim();

      // Use patient name as device name, or a default name if empty
      final deviceName = patientName.isNotEmpty
          ? patientName
          : 'جهاز $deviceId';
  ...
  void _savePatientInfo(BuildContext context) {
